...
class TestCount(unittest.TestCase):
    ...
    @parameterized.expand(
        [
            ...
            ("micro/micro", Period.of_microseconds(100).with_microsecond_offset(5), Period.of_microseconds(10).with_microsecond_offset(5), -1),
            ...
            ("micro/second", Period.of_microseconds(100_000).with_microsecond_offset(5), Period.of_seconds(1).with_microsecond_offset(5), 10),
            ...
            ("second/second", Period.of_seconds(100).with_microsecond_offset(5), Period.of_seconds(10).with_microsecond_offset(5), -1),
            ("second/second", Period.of_seconds(10).with_microsecond_offset(5), Period.of_seconds(100).with_microsecond_offset(5), 10),
