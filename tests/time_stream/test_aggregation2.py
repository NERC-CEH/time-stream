...
def generate_time_series(resolution, periodicity, length, missing_data=False):
...
def generate_expected_df(timestamps, aggregator, columns, values, expected_counts, actual_counts,
                         timestamps_of=None, valid=None):
