...
class TestTimeframeRepr:
    ...
    def test_basic_repr(self, timeframe: TimeFrame) -> None:
        ...
        assert result == (
            ...
            "shape: (5, 4)\n"
            "┌─────────────────────┬──────┬──────┬───────┐\n"
            "│ timestamp           ┆ col1 ┆ col2 ┆ flag1 │\n"
            "│ ---                 ┆ ---  ┆ ---  ┆ ---   │\n"
            "│ datetime[μs]        ┆ i64  ┆ f64  ┆ i64   │\n"
            "╞═════════════════════╪══════╪══════╪═══════╡\n"
            "│ 2025-01-01 00:00:00 ┆ 10   ┆ 1.1  ┆ 1     │\n"
            "│ 2025-01-02 00:00:00 ┆ 20   ┆ 2.2  ┆ 1     │\n"
            "│ 2025-01-03 00:00:00 ┆ 30   ┆ 3.3  ┆ 2     │\n"
            "│ 2025-01-04 00:00:00 ┆ 40   ┆ 4.4  ┆ 2     │\n"
            "│ 2025-01-05 00:00:00 ┆ 50   ┆ 5.5  ┆ 2     │\n"
            "└─────────────────────┴──────┴──────┴───────┘"
        )
