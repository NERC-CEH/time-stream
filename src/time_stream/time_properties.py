...
from time_stream.exceptions import ColumnNotFoundError, ColumnTypeError, PeriodicityError, ResolutionError
from time_stream.utils import configure_period_object, truncate_to_period


class TimeProperties:
    """Handles resolution and periodicity validation for a TimeSeries."""
    ...
    def _validate_resolution(self, dt: pl.Series) -> None:
        ...
        resolution_check = dt.equals(truncate_to_period(dt, self.resolution))
    ...
    def _validate_periodicity(self, dt: pl.Series) -> None:
        ...
        periodicity_check = truncate_to_period(dt, self.periodicity).n_unique() == dt.len()
