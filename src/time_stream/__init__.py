...
def __getattr__(name: str) -> Any:
    ...
    #   `time_stream.base` exist. This avoids import-time errors when building from source using pyproject.toml
    #   and ensures compatibility with dynamic versioning tools like autosemver.
    #
