...
from time_series.columns import TimeSeriesColumn, DataColumn, FlagColumn, PrimaryTimeColumn, SupplementaryColumn
...
class TimeSeries:
    ...
    def init_supplementary_column(
        self, col_name: str, data: Optional[Union[int, float, str, Iterable]] = None, dtype: Optional[pl.DataType] = None
    ) -> None:
